...
export default function DashboardPage() {
  ...
  //         <p className="text-zinc-400 mb-4">You need to sign in to access your dashboard.</p>
    ...
    <div className="min-h-screen bg-[#0a0a0b] text-zinc-100">
      ...
      <main className="p-6 md:p-8 max-w-6xl mx-auto">
        ...
        <p className="text-zinc-500 mb-8">
          Create invoices, track payments, and manage clients. (Coming soon)
        </p>
        <div className="surface rounded-2xl border border-white/10 p-8 text-center text-zinc-500">
          Placeholder – integrate your Express user APIs here.
        </div>
      </main>
    </div>
  );
